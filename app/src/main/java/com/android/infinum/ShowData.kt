...
object ShowData {
    val shows = listOf(
        ...
        ShowsModel("2","Daredevil","A blind lawyer by day, vigilante by night. Matt Murdock fights the crime of New York as Daredevil.",
            listOf(
                ReviewModel("Test",5.0f, R.drawable.super_mario),
            ReviewModel
            ("Jako jako puno previše mnogo jako veliko puno veliki komentar na review ove serije u par redova da Brane bude sretan i da mogu krenuti na 5. i 6. zadacu",1.0f,R.drawable.super_mario)),R.drawable.daredevil),
